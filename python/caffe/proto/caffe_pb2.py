...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pushin_param', full_name='caffe.LayerParameter.pushin_param', index=51,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pruning_param', full_name='caffe.LayerParameter.pruning_param', index=52,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crelu_param', full_name='caffe.LayerParameter.crelu_param', index=53,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fixed_param', full_name='caffe.LayerParameter.fixed_param', index=54,
...
_PUSHINPARAMETER = _descriptor.Descriptor(
  name='PushinParameter',
  full_name='caffe.PushinParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pushin_ratio', full_name='caffe.PushinParameter.pushin_ratio', index=0,
      number=1, type=2, cpp_type=6, label=1,
...
_PRUNINGPARAMETER = _descriptor.Descriptor(
  name='PruningParameter',
  full_name='caffe.PruningParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='coeff', full_name='caffe.PruningParameter.coeff', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CRELUPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='engine', full_name='caffe.cReLUParameter.engine', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FIXEDPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='fixed', full_name='caffe.FixedParameter.fixed', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['pushin_param'].message_type = _PUSHINPARAMETER
_LAYERPARAMETER.fields_by_name['pruning_param'].message_type = _PRUNINGPARAMETER
...
DESCRIPTOR.message_types_by_name['PushinParameter'] = _PUSHINPARAMETER
DESCRIPTOR.message_types_by_name['PruningParameter'] = _PRUNINGPARAMETER
...
class PushinParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PUSHINPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.PushinParameter)

class PruningParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PRUNINGPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.PruningParameter)

class cReLUParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _CRELUPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.cReLUParameter)

class FixedParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
